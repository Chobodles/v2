...
function validateAndSubmit() {
    ...
    // Field names match blotter table columns exactly:
    ...
    const data = {
        ...
        suffix:            form.querySelector('[name="suffix"]').value.trim(),
        ...
        complaint_type:    form.querySelector('[name="complaint_type"]').value.trim(),
